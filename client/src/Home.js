      ...
      <div className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <div className="sidebar-content">
          ...
          <nav className="sidebar-nav" aria-label="Sidebar navigation">
            ...
            <Link to="/weather" className="sidebar-nav-link" aria-label="Weather"><span role="img" aria-label="Weather">🌤️</span> Weather</Link>
            <Link to="/tech-predictions" className="sidebar-nav-link" aria-label="Tech Predictions"><span role="img" aria-label="Tech">🤖</span> Tech Predictions</Link>
